...
=== CS-Cart to OpenCart Migration Tool ===
Version: 2.4.1
Developed by: LitExtension
Download: https://litextension.com/opencart-migration/cscart-to-opencart-migration.html


== Description ==
LitExtension CS-Cart to OpenCart Migration Tool allows you to migrate your products, orders, customers, passwords and other data from CS-Cart to OpenCart automatically.
